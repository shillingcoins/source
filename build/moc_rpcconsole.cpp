...
**
** Created: Tue Feb 11 13:35:06 2014
...
static const char qt_meta_stringdata_RPCExecutor[] = {
    "RPCExecutor\0\0category,command\0"
    "reply(int,QString)\0command\0request(QString)\0"
};
...
const QMetaObjectExtraData RPCExecutor::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject RPCExecutor::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_RPCExecutor,
      qt_meta_data_RPCExecutor, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &RPCExecutor::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_RPCExecutor))
