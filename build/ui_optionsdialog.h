...
**
** Created: Tue Feb 11 11:39:25 2014
...
public:
    ...
    ShillingAmountField *transactionFee;
    QSpacerItem *horizontalSpacer_1_Main;
    QCheckBox *shillingAtStartup;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        transactionFee = new ShillingAmountField(tabMain);
        ...
        shillingAtStartup = new QCheckBox(tabMain);
        shillingAtStartup->setObjectName(QString::fromUtf8("shillingAtStartup"));

        verticalLayout_Main->addWidget(shillingAtStartup);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        shillingAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Shilling after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        shillingAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Shilling on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Shilling client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Shilling network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Shilling.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show Shilling addresses in the transaction list or not.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
