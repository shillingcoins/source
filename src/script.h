...
#ifndef H_SHILLING_SCRIPT
#define H_SHILLING_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CShillingAddress
 */
...
public:
    ...
    // Pre-version-0.6, Shilling always counted CHECKMULTISIGs
