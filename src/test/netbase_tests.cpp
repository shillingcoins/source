...
{
    BOOST_CHECK(TestSplitHost("www.shilling.org", "www.shilling.org", -1));
    BOOST_CHECK(TestSplitHost("[www.shilling.org]", "www.shilling.org", -1));
    BOOST_CHECK(TestSplitHost("www.shilling.org:80", "www.shilling.org", 80));
    BOOST_CHECK(TestSplitHost("[www.shilling.org]:80", "www.shilling.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8334", "127.0.0.1", 8334));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8334", "127.0.0.1", 8334));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8334", "::ffff:127.0.0.1", 8334));
    BOOST_CHECK(TestSplitHost("[::]:8334", "::", 8334));
    BOOST_CHECK(TestSplitHost("::8334", "::8334", -1));
    BOOST_CHECK(TestSplitHost(":8334", "", 8334));
    BOOST_CHECK(TestSplitHost("[]:8334", "", 8334));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8334", "127.0.0.1:8334"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8334", "[::]:8334"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
