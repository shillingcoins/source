    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new ShillingUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->shillingAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Shilling."), QMessageBox::Ok);
